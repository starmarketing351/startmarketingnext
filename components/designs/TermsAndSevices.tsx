  ...
  return (
    <section className="bg-white py-12">
      <div className="container mx-auto max-w-7xl px-4">
        <h2 className="text-4xl font-bold text-center mb-12">Terms and Services</h2>
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {termsOfServiceContent.map(
            ({
              ...
              note,
              points,
            }: termsOfServiceContentInterface, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-lg h-full flex flex-col">
