    ...
    >
      <div className="max-w-3xl mx-auto text-center">
        <motion.h1
          ...
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.8, duration: 1.2 }} // Increased delay and duration
        >
          {bannerData.header}
        </motion.h1>
        ...
        <motion.h3
          ...
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 1.5, duration: 1.2 }} // Increased delay and duration
        >
          {bannerData.para}
        </motion.h3>
      </div>
      <motion.div
        ...
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 2, duration: 1.2 }} // Increased delay and duration
      >
